...
plot2(SelectedData, Timestamps, ylab = "Global Active Power")
plot3(SelectedData, Timestamps, bty = "n")
plot4(SelectedData, Timestamps)
plot5(SelectedData, Timestamps)
...
# ----------------------------------------------------------------------
#pngDev = dev.copy(png, file = "plot4.png")
#dev.off(pngDev)
